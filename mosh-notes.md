...
d. `#`     - denotes the privileges. A hash means that we have the highest priviledges as the root user. If we login as a different 
             user, we will get a $ (dollar)  of # (hash).
